...
1. Run `uv run pytest --cov ffmpeg_progress --cov-branch --cov-report term-missing:skip-covered`
...
4. Run `uv run pytest --cov ffmpeg_progress --cov-branch --cov-report term-missing:skip-covered`
