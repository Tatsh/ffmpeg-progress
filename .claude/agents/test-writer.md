...
You write comprehensive pytest test suites for ffmpeg-progress. Follow all conventions in
...
def test_my_command_success(runner: CliRunner, mocker: MockerFixture) -> None:
    mock_func = mocker.patch('ffmpeg_progress.commands.module.some_function')
